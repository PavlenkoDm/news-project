...
export class TemplateCards {
  ...
  buildTemplate(start, end) {
    ...
    <div class="markup-unit__image-wrapper"> 
      ...
      alt="placeholder"
      />
      ${currentRead?.some(readNews => readNews.link === unload.path)
      ...
      >
      ${
        currentFavourite?.some(
          favouriteNews => favouriteNews.link === unload.path
        )
    ...
    <div class="markup-unit__details" style="pointer-events:none;">
      <div class="markup-unit__subdetails" style="pointer-events:none;">
        ...
        <div class="markup-unit__card-footer" style="pointer-events:none;">
          <p class="markup-unit__card-date" style="pointer-events:none;">${
            unload.date
          }</p>
          <p class="markup-unit__read-more" style="pointer-events:none;">Read more</p>
        </div>
      </div>
    </div>
</a>
